...
;;(autoload 'matlab-mode "~/.emacs_files/matlab.el" "Enter Matlab mode." t)
;;(setq auto-mode-alist (cons '("\\.m\\'" . matlab-mode) auto-mode-alist))
;;(autoload 'matlab-shell "~/.emacs_files/matlab.el" "Interactive Matlab mode." t)


;; php mode
(autoload 'php-mode "~/.emacs_files/php-mode.el" "PHP editing mode" t)
